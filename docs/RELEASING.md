...
- Tags like `0.5.0`, `1.0.0`, `2.1.3` become release versions
- Development versions show as `0.5.0.dev12+g2c67fb6` (12 commits after 0.5.0)
...
4. Click "Choose a tag" and **type a new tag** (e.g., `0.5.0`, `1.0.0a1`)
